...
public class Human {
    ...
    Human(String surname, String name, int year,int iq) {
        this.surname = surname;
        this.name = name;
        this.year = year;
        this.iq = iq;}
    Human(String surname, String name, int year, Human mother, Human father) {
        this.surname = surname;
        this.name = name;
        this.year = year;
        this.mother = mother;
    ...
    private String[][] generateRandomSchedule(){
        ...
        for (int i = 0; i < randomSchedule.length; i++){
            randomSchedule[i][0]=daysOfWeek[i];
    ...
    void greetPet() {System.out.println("Hello " + pet.getNickname());}
    void describePet() {System.out.println(pet.getDescribePet());}
    @Override
