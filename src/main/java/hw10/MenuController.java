...
public class MenuController {
    ...
    public void start() {
        while (true) {
            ...
            try {
                switch (input) {
                    case "1": familyService.loadFamiliesFromFile(FamilyService.DEFAULT_FILE_PATH);break;
                    ...
                    case "10": System.out.print("Введіть шлях для збереження файлу: ");
                        ...
                        familyService.saveFamiliesToFile(pathSave);break;
                    case "11": familyService.fillWithTestData();break;
    ...
    private void editFamily() {
        ...
        switch (input) {
            ...
            case "2" : try {
                ...
                familyService.adoptChild(id, child);
